  ...
  if (Serial.available() > 0) {
    ...
    switch (incomingByte) {
      ...
      case 'H':
        ...
        // Close hand
        imservo.slowmove(30, 30); // 70deg ROM, 30 speed
        //thumbservo.slowmove(30, 30); // 30deg ROM, 30 speed
      break;

      case 'L':
        digitalWrite(ledPin, HIGH);
        // Open hand
        imservo.slowmove(100, 10); // 70deg ROM, 10 speed
        //thumbservo.slowmove(0, 10); // 30deg ROM, 10 speed
      break;
    }
  }
}
